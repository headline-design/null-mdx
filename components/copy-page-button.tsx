...
export function CopyPageButton({ content, className }: CopyPageButtonProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "text-sm text-muted-foreground hover:bg-muted/50 flex cursor-pointer items-center gap-2 rounded-full px-2 py-2 font-medium transition-all duration-200 md:py-1.5 md:pl-2.5",
